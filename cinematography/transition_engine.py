...
TRANSITIONS_CATALOG = {
    "crossfade": TransitionDefinition(
        ...
        ffmpeg_filter_template="xfade=transition=fade:duration={duration}:offset=0",
        default_duration=1.0,
    ),
    "dissolve": TransitionDefinition(
        name="Dissolve",
        description="Smooth dissolve transition",
        ffmpeg_filter_template="xfade=transition=dissolve:duration={duration}:offset=0",
        default_duration=0.5,
    ),
    "fade_black": TransitionDefinition(
        name="Fade to Black",
        description="Fade out to black and fade in",
        ffmpeg_filter_template="xfade=transition=fadeblack:duration={duration}:offset=0",
        default_duration=1.0,
    ),
    "fade_white": TransitionDefinition(
        name="Fade to White",
        description="Fade out to white and fade in",
        ffmpeg_filter_template="xfade=transition=fadewhite:duration={duration}:offset=0",
        default_duration=1.0,
    ),
    "slide_left": TransitionDefinition(
        name="Slide Left",
        description="Second clip slides in from right",
        ffmpeg_filter_template="xfade=transition=slideright:duration={duration}:offset=0",
        default_duration=1.0,
    ),
    "slide_right": TransitionDefinition(
        name="Slide Right",
        description="Second clip slides in from left",
        ffmpeg_filter_template="xfade=transition=slideleft:duration={duration}:offset=0",
        default_duration=1.0,
    ),
    "slide_up": TransitionDefinition(
        name="Slide Up",
        description="Second clip slides in from bottom",
        ffmpeg_filter_template="xfade=transition=slidedown:duration={duration}:offset=0",
        default_duration=1.0,
    ),
    "slide_down": TransitionDefinition(
        name="Slide Down",
        description="Second clip slides in from top",
        ffmpeg_filter_template="xfade=transition=slideup:duration={duration}:offset=0",
        default_duration=1.0,
    ),
    "wipe_right": TransitionDefinition(
        name="Wipe Right",
        description="Right-to-left wipe transition",
        ffmpeg_filter_template="xfade=transition=wiperight:duration={duration}:offset=0",
        default_duration=1.0,
    ),
    "wipe_left": TransitionDefinition(
        name="Wipe Left",
        description="Left-to-right wipe transition",
        ffmpeg_filter_template="xfade=transition=wipeleft:duration={duration}:offset=0",
        default_duration=1.0,
    ),
    "zoom_in": TransitionDefinition(
        name="Zoom In",
        description="Zoom transition between clips",
        ffmpeg_filter_template="xfade=transition=zoomin:duration={duration}:offset=0",
        default_duration=1.0,
    ),
    "blur_transition": TransitionDefinition(
        name="Blur Transition",
        description="Blur effect transition",
        ffmpeg_filter_template="xfade=transition=hblur:duration={duration}:offset=0",
        default_duration=1.0,
    ),
}
